...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"bmiCalculator.test.js":[function(require,module,exports) {
...
test('Calculate BMI with metric units', function () {
  // Arrange
  var height = 180; // in centimeters
  var weight = 75; // in kilograms

  // Act
  var result = calculateBMI(height, weight, 'cm', 'kg');
...
test('Calculate BMI with imperial units', function () {
  // Arrange
  var height = 70; // in inches
  var weight = 150; // in pounds

  // Act
  var result = calculateBMI(height, weight, 'in', 'lb');
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","bmiCalculator.test.js"], null)
//# sourceMappingURL=/bmiCalculator.test.242a0431.js.map